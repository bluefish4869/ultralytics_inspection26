...
from utils.data_loader import ImageLoader, VideoDataLoader, create_loader
...
def main():
    ...
    parser.add_argument("--config", "-c", type=str, default="configs/config.yaml", help="配置文件路径")
    ...
    if is_save and is_video and save_video:
        ...
        video_writer = cv2.VideoWriter(str(output_path), fourcc, loader.fps, (loader.width, loader.height))
